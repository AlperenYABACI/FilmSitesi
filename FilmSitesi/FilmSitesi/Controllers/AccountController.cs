    ...
    public class AccountController : Controller
    {
        ...
        public IActionResult Login(LoginViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    if (user.Locked)
                    {
                        ModelState.AddModelError(nameof(model.Username), "Kullanıcı Engellenmiş!");
                        return View(model);
                    }
        ...
        public IActionResult Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(nameof(model.Username), "Kullanıcı Adı Zaten Alınmış!");
                    View(model);
                }
                ...
                {
                    ModelState.AddModelError("", "Kullanıcı Eklenirken Bir Problem Oluştu!");
                }
                else
                {
